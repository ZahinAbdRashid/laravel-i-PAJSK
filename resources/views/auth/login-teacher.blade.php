    ...
    <div class="bg-white w-full lg:w-7/12 xl:w-3/5 flex flex-col justify-center items-center p-6 md:p-8 lg:p-12 order-1 lg:order-1">
        <div class="w-full max-w-md xl:max-w-lg">
            <div class="mb-6 md:mb-8 lg:mb-12 flex justify-center">
                <img src="{{ asset('images/logo sekolah.png') }}" alt="School Logo" class="w-48 md:w-56 lg:w-64 xl:w-72">
            </div>
            ...
            <div class="mt-4 md:mt-6 text-center">
                <p class="text-base md:text-lg text-slate-600 italic leading-relaxed mb-3">
                    "Generating holistic excellence beyond the classroom."
                </p>
                <div class="w-12 h-1 bg-indigo-500 rounded mx-auto"></div>
            </div>
        </div>
    </div>

    <!-- Login Form Section -->
    <div class="bg-indigo-900 w-full lg:w-5/12 xl:w-2/5 flex flex-col justify-center items-center p-6 md:p-8 lg:p-12 order-2 lg:order-2">
        <div class="w-full max-w-md">
            <div class="mb-6 md:mb-8">
                ...
                <p class="text-blue-100 text-sm md:text-base">
                    Please enter your IC and Password.
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('login.submit') }}" class="space-y-4 md:space-y-6">
                ...
                <!-- User Experience -->
                <div class="pt-4 md:pt-6 border-t border-indigo-700">
                    <p class="text-blue-200 text-xs md:text-sm text-center">
                        For The Best Experience Please Use Laptop Or Desktop
                    </p>
                </div>
            </form>
        </div>
